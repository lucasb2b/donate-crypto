  ...
  return (
    <>
      <div className="container">
        <h1 className="display-5 fww-bold text-body-emphasis lh-1 mb-3 mt-5">
          Donate Crypto
        </h1>
        <p>
          Verifique se esta campanha é a correta antes de finalizar sua doação.
        </p>
        <hr />
        <div className="row flex-lg-row-reverse align-items-center g-5">
          ...
          <div className="col-5 mb-5" style={{ height: 480, scrollbars: true }}>
            ...
            <p className="mb-3 fst-italic mt-5">
              E aí, o que achou do projeto? Já foi arrecado{" "}
